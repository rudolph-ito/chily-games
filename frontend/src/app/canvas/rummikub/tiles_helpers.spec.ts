...
let examples: Example[] = [
  ...
  },
  {
    ...
    input: {
      pool: [{rank: 1, color: TileColor.BLACK}, {rank: 1, color: TileColor.RED}, {rank: 1, color: TileColor.BLUE}],
      list: [{rank: 1, color: TileColor.RED}],
    },
    output: [1]
  },
  {
    ...
    input: {
      pool: [{rank: 1, color: TileColor.BLACK}, {rank: 1, color: TileColor.RED}, {rank: 1, color: TileColor.BLUE},  {rank: 1, color: TileColor.YELLOW}],
      list: [{rank: 1, color: TileColor.RED}, {rank: 1, color: TileColor.YELLOW}],
    },
    output: [1, 3]
  },
  {
    ...
    input: {
      pool: [{rank: 1, color: TileColor.BLACK}, {rank: 1, color: TileColor.RED}, {rank: 1, color: TileColor.RED}],
      list: [{rank: 1, color: TileColor.RED}],
    },
    output: [1]
  },
  {
    ...
    input: {
      pool: [{rank: 1, color: TileColor.BLACK}, {rank: 1, color: TileColor.RED}, {rank: 1, color: TileColor.RED}],
      list: [{rank: 1, color: TileColor.RED}, {rank: 1, color: TileColor.RED}],
    },
    output: [1, 2]
  }
]
