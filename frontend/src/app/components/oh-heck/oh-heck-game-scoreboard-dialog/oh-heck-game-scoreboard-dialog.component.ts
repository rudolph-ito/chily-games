...
import { IGame, IRoundScore } from "src/app/shared/dtos/oh_heck/game";
import { computeTotalScore, ITotalScore } from "src/app/utils/oh-heck/score-helpers";
...
export class OhHeckGameScoreboardDialogComponent implements OnInit {
  ...
  ngOnInit(): void {
    let data: (IRoundScore | ITotalScore)[] = this.data.game.roundScores;
    data = data.concat([
      computeTotalScore(
